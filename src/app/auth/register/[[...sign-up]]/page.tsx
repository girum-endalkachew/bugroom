    ...
    <div className="min-h-screen bg-midnight flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="w-full max-w-md flex flex-col items-center space-y-4">
        <div className="text-center space-y-1 mb-2">
          <h1 className="text-2xl font-semibold text-paper font-sans">Create Workspace Account</h1>
          <p className="text-xs text-ash font-mono">INITIALIZE_INVESTIGATOR_IDENTITY</p>
        </div>
