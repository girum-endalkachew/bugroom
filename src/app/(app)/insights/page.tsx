    ...
    <div className="p-8 space-y-8 max-w-6xl mx-auto">
      <div>
        <div className="flex items-center gap-2 text-signal-blue text-sm font-mono font-medium mb-1">
          <BarChart3 className="h-4 w-4" /> WORKSPACE AND PERSONAL ANALYTICS
        </div>
