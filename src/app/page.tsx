...
import { HexGraphic } from "@/components/marketing/hex-graphic";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-midnight text-paper overflow-x-hidden selection:bg-ember/30 selection:text-paper">
      ...
      <div className="fixed inset-0 bg-midnight [mask-image:radial-gradient(ellipse_80%_80%_at_50%_0%,#000_20%,transparent_100%)] pointer-events-none" />
      ...
      <main className="relative z-10 pt-20 pb-8 px-6">
        ...
        <motion.section
          ...
          className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[70vh]"
        >
          {/* Left Text */}
          <div className="space-y-8 text-left z-10">
            ...
            <motion.h1 variants={fadeUp} className="text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tight leading-[1.08] text-transparent bg-clip-text bg-gradient-to-b from-paper via-paper to-ash">
              Software fails <br />
              in chapters
            </motion.h1>

            <motion.p variants={fadeUp} className="text-lg text-ash max-w-xl leading-relaxed">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-4 pt-2">
              <Link href="/overview">
                <Button variant="primary" size="lg" className="rounded-full px-8 h-12 shadow-[0_0_20px_rgba(255,104,53,0.3)]">
                  Start Investigating
                </Button>
              </Link>
              <Link href="/bugs/bug-0482">
                <Button variant="secondary" size="lg" className="rounded-full px-8 h-12 border-graphite-border">
                  Open sample case
                </Button>
              </Link>
            </motion.div>
          ...
          {/* Right Graphic */}
          <motion.div variants={fadeUp} className="relative z-0">
            <HexGraphic />
          </motion.div>
        </motion.section>
        ...
        <motion.section
          ...
          variants={staggerContainer}
          className="max-w-6xl mx-auto mt-32 grid grid-cols-1 md:grid-cols-3 gap-6 pb-8"
        >
